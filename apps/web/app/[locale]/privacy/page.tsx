  ...
  return (
    <LegalLayout title="Privacy Policy" updated="September 23, 2026">
      ...
      <ul>
        ...
        <li>
          <strong>Your theme and language choices.</strong> If you pick a light or dark theme, your browser keeps that choice
          in its local storage. It stays on your device and is not sent to us. If you pick a language, we save it in a
          small cookie (<code>NEXT_LOCALE</code>) for one year, so the site opens in that language the next time you visit.
          Your browser sends this cookie to us with page requests. It holds only the language code and is not used to
