...
export default function NotFound() {
  ...
  return (
    <div className="container-tool flex flex-col items-center py-28 text-center sm:py-36">
      ...
      <Link href={localePath(locale, '/')} className="press mt-8 inline-flex h-12 items-center rounded-2xl bg-brand-gradient px-7 text-[15px] font-bold text-on-brand shadow-glow transition-[filter] hover:brightness-110">
        {t.notFound.button}
      </Link>
    </div>
  );
