      ...
      <div className="relative mx-auto mt-10 max-w-3xl text-left">
        ...
        <div className="group relative overflow-hidden rounded-[28px] p-[1.5px]">
          <div
            ...
            style={{ background: 'conic-gradient(from 0deg, transparent 0 55%, #ffab5c 72%, #ff5a3c 84%, #c81f2e 92%, transparent 100%)' }}
            aria-hidden
          />
          ...
          <div className="relative rounded-[26.5px] bg-base-surface p-3 sm:p-4">
            <form onSubmit={handleSubmit}>
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                <div className="flex min-w-0 flex-1 items-center gap-2 rounded-2xl bg-base px-4">
