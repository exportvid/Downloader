...
export const ko: Record<PlatformSlug, PlatformContent> = {
  ...
  'instagram-video-downloader': {
    metaTitle: '인스타그램 동영상 다운로더: 릴스, 동영상, 스토리',
    metaDescription:
      '인스타그램 릴스, 동영상, 스토리를 MP4로 무료 다운로드하세요. 사진과 캐러셀도 지원해요. 인스타그램 링크를 붙여넣으면 ExportVid가 파일을 찾아 줘요.',
    h1: '인스타그램 동영상 다운로드',
    intro: '인스타그램 릴스, 동영상 게시물, 스토리 링크를 붙여넣고 MP4로 다운로드하세요. 사진 게시물과 캐러셀도 지원해요.',
    about: [
    ...
    faqs: [
      {
        q: '인스타그램 동영상은 어떻게 다운로드하나요?',
        a: '인스타그램에서 릴스나 게시물 링크를 복사해 위 입력란에 붙여넣고 다운로드를 선택하세요. 그런 다음 원하는 파일을 고르세요.',
      },
      {
      ...
      {
        q: '캐러셀의 동영상과 사진을 모두 다운로드할 수 있나요?',
        a: '네. 캐러셀의 각 동영상과 사진이 저마다 다운로드 버튼과 함께 목록에 표시돼요.',
      },
      {
